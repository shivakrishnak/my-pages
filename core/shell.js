...
(function () {
  ...
  function initScrollSpy() {
    ...
    var tocLinks = document.querySelectorAll('.ms-toc a, .ms-nav-item.sub[href*="#"]');
  ...
  function highlightCurrent() {
    ...
    document.querySelectorAll('.ms-nav-item:not(.sub)').forEach(function (link) {
      var href = link.getAttribute('href') || '';
  ...
  function initBottomNav() {
    ...
    btns.forEach(function (btn) {
      btn.addEventListener('click', function () {
        ...
        if (action === 'menu') { window.openSidebar && window.openSidebar(); }
